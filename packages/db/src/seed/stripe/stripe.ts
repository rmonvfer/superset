...
import { PriceKey, PRO_PRODUCT_CONFIG, ProductType } from "@superset/stripe";
import { getProProductAndPrices } from "@superset/stripe/src/scripts/dev/product";
...
export const seedStripe = async () => {
	...
	const { product: stripeProduct, prices: stripePrices } =
		await getProProductAndPrices();
