import {
	...
	type AVerificationRecord,
	type TxtVerificationRecord,
...
export const customDomainVerificationRelations = relations(
...
export type CustomDomainVerification =
	typeof customDomainVerification.$inferSelect;
