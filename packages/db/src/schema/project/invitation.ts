...
export const projectInvitationInsertSchema =
	createInsertSchema(projectInvitations);
export const projectInvitationUpdateSchema =
	createUpdateSchema(projectInvitations);
